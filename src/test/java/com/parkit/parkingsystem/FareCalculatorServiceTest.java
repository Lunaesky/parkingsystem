...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void calculateFareBikeWithADayParkingTime(){
        Date inTime = new Date ();
        inTime.setTime( System.currentTimeMillis() - (24 * 60 * 60 * 1000));
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE, false);
    ...
    @Test
    public void calculateThirtyMinutesFreeCar(){
        Date inTime = new Date();
    ...
    @Test
    public void calculateThirtyMinutesFreeBike(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - ( 30 * 60 * 1000) );
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1,ParkingType.BIKE, false);
    ...
    public void calculateFivePercentForRecurringUsersBike(){
        ...
        fareCalculatorService.calculateFare(ticket);
        assertEquals(0.95, 0.95 * Fare.BIKE_RATE_PER_HOUR, ticket.getPrice());
    ...
    public void calculateFivePercentForRecurringUsersCar(){
        ...
        ticket.setVehicleRegNumber("ABCDEF");
        fareCalculatorService.calculateFare(ticket);
        assertEquals(1.42,  0.95 * Fare.CAR_RATE_PER_HOUR, ticket.getPrice());
